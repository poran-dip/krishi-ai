...
const QuickActions = () => {
  return (
    <div className="grid grid-cols-3 gap-3 md:gap-4">
      <button className="flex-1 flex flex-col sm:flex-row items-center gap-2 md:gap-3 p-2 md:p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors border border-blue-200 cursor-pointer">
      ...
      <button className="flex-1 flex flex-col sm:flex-row items-center gap-2 md:gap-3 p-2 md:p-4 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors border border-indigo-200 cursor-pointer">
      ...
      <button className="flex-1 flex flex-col sm:flex-row items-center gap-2 md:gap-3 p-2 md:p-4 bg-yellow-50 hover:bg-yellow-100 rounded-lg transition-colors border border-yellow-200 cursor-pointer">
